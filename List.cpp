...
void stk::insert(int newEl, size_t index)
{
...
void stk::set(size_t index, int newData)
{
	Node* cur = head;
	if (index >= size || index < 0)
		throw out_of_range("Index is greater than list size");
...
size_t stk::find_first(stk* list)
{
	int counter = 0;
	Node* curL1, * curL2;
	curL1 = (*list).head;
